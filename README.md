...
| `finalize-issue` | [#17 splash page](https://github.com/Corneliuses/psn/issues/17) — all acceptance criteria verified against [PR #24](https://github.com/Corneliuses/psn/pull/24), planning docs archived to [`.agents/archive/issue-planner/17/`](./.agents/archive/issue-planner/17), merged, and closed |
